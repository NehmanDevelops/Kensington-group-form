export default async function handler(req, res) {
  ...
  try {
    ...
    if (sendCopy && recipientEmail && process.env.RESEND_API_KEY) {
...
<body style="margin:0;padding:0;background:#f5f1e8;font-family:'Inter',Arial,sans-serif;">
  <div style="max-width:600px;margin:40px auto;background:#fff;border:1px solid #d9d2c2;">
    ...
    <div style="padding:40px 48px;">
      ...
      <p style="color:#4a4a45;font-size:14px;line-height:1.7;margin:0 0 32px;">Your group travel request has been received. Your dedicated Kensington travel agent will be in contact within 24 business hours to finalize the details.</p>
      ...
      <p style="color:#7d7a73;font-size:12px;line-height:1.6;margin:0;">If you need to make any changes or have questions, please contact your travel agent.</p>
    </div>
